...
export const api = {
  ...
  adminUpsertProvider: (body: Record<string, unknown>) => apiCall('/v1/admin/llm-providers', { body, method: 'POST' }),
  adminDeleteProvider: (id: string) => apiCall(`/v1/admin/llm-providers/${encodeURIComponent(id)}`, { method: 'DELETE' }),
  adminLlmModels: () => apiCall('/v1/admin/llm-models'),
  adminUpsertModel: (body: Record<string, unknown>) => apiCall('/v1/admin/llm-models', { body, method: 'POST' }),
